...
public enum AdventureEnum {
    ...
    FANDORA(15, "太空翻车鱼", "翻车鱼|空牙|飞船|飞艇|飞翼犀牛|外星人母后|死域海的灯塔|玄化|Boss|boss|BOSS|碑像天使|亚兹卢恩死月弓碑|太空旋风", "神秘飞船的目的地是——" + FIELD_CELESTIA),
    KOZAKY(16, "平庸鬼", "自爆", "看，平庸鬼！" + FIELD_GRAVE),
    SHIP(17, "灵魂护送船", "灵魂船|幽灵船|传说的渔人|海皇子 尼普深渊王|熔岩裁决王|炎王兽 甘尼许|忘却的海底神殿|舍利军贯|军舰", "一艘被恶灵占领的破船……" + FIELD_SEA),
